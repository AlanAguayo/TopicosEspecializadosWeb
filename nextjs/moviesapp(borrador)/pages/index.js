...
export default function Home(initialData) {
  ...
  const search = async (event) =>{
    ...
    let movies = await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${process.env.apiKey}&languaje=en-US&query=${formInputs.searchTerm}&page-1&include_adult=false`)
...
export async function getServerSideProps(context){
  ...
  return {
    props:{trendingMovies: trendingMovies}, //envia los datos como props
  }
}