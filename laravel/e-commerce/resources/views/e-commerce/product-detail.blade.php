                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <div class="product-slider-single-nav normal-slider">
                                        @for ($i = 0; $i < 6; $i++)
                                            <div class="slider-nav-img"><img src="{{ URL::asset('img/' . $item->image) }}"
                                                    alt="Product Image">
                                            </div>
                                        @endfor
                                    </div>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="p-size">
                                            ...
                                            <div class="btn-group btn-group-sm">
                                                <button type="button" class="btn">{{ $item->size }}</button>
                                            </div>
                                        </div>
                                        <div class="p-color">
                                            <h4>Color:</h4>
                                            <div class="btn-group btn-group-sm">
                                                <button type="button" class="btn">{{ $item->color }}</button>
                                            </div>
                                        </div>
                                        <div class="action">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="reviews" class="container tab-pane fade">
                                        ...
                                        <div class="reviews-submit">
                                            ...
                                            <form action="{{ route('review_post', $item->id) }}" method="post">
                                                <div class="row form">
                                                    @csrf
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea placeholder="Review" name="review" value="{{ old('review') }}" required></textarea>
                                                    </div>
                                                    <div class="col-sm-12">
